...
async def post_imagen(mje,media,Sensitive=False, formato='png',visibilidad='public'):
...
def video(mje,media,*args, Sensitive=False, formato='mp4',visibilidad='public'):
    numerales = ''
    for arg in args:
        numerales += f'#{arg} '
...
def imagen(mje,media,*args, Sensitive=False, formato='png',visibilidad='public'):
    numerales = ''
    for arg in args:
        numerales += f'#{arg} '
